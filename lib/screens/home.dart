...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final rutineStreamRef = ref.watch(ruitneStream);
    print('build');
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: rutineStreamRef.when(
                data: (rutines) => Column(
                  children: [
                    for (final rutine in rutines)
                      ListTile(
                        leading: Text(rutine.id.toString()),
                        title: Text(rutine.name.toString()),
                        subtitle: Text(rutine.address.toString()),
                        trailing: SizedBox(
                          width: 100,
                          child: Row(
